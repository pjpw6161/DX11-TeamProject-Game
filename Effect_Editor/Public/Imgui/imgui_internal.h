...
struct IMGUI_API ImGuiWindow
{
    ...
    ImS8                    HiddenFramesForRenderOnly;          // Hide the window until frame N at DrawEditor() time only
...
namespace ImGui
{
    ...
    // - You are calling ImGui functions after ImGui::EndFrame()/ImGui::DrawEditor() and before the next ImGui::NewFrame(), which is also illegal.
...
//#endif
    ...
    // DrawEditor helpers (those functions don't access any ImGui state!)
