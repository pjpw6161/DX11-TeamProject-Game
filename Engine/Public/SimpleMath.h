...
namespace DirectX
{
    namespace SimpleMath
    {
        ...
        struct Vector3 : public XMFLOAT3
        {
            ...
            Vector3& operator= (const XMFLOAT4& F) noexcept { x = F.x; y = F.y; z = F.z; return *this; }
        ...
        struct Vector4 : public XMFLOAT4
        {
            ...
            Vector4(Vector3 V, float W = 0.f) noexcept { XMStoreFloat4(this, V); w = W; }
            ...
            Vector4& operator/= (float S) noexcept;
            Vector4& operator=(const Vector3& V) noexcept { x = V.x; y = V.y; z = V.z; return *this; }
            ...
            Vector4 Get_Normalized() const noexcept;
