...
{
    m_strModelTag = TEXT("Prototype_Model_Select_Map");
...
HRESULT CSelect_Map::Add_Components()
{
    ...
    if (FAILED(__super::Add_Component(LEVEL_ShaderTest, m_strModelTag, TEXT("Com_Model"), reinterpret_cast<CComponent**>(&m_pModelCom))))
    {
        return E_FAIL;
    }
