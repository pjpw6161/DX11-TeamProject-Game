...
CShader_Camera::CShader_Camera(_dev pDevice, _context pContext)
	: CCamera(pDevice, pContext)
{
}

CShader_Camera::CShader_Camera(const CShader_Camera& rhs)
	: CCamera(rhs)
{
}

HRESULT CShader_Camera::Init_Prototype()
{
	return S_OK;
}

HRESULT CShader_Camera::Init(void* pArg)
{
...
void CShader_Camera::Tick(_float fTimeDelta)
{
...
void CShader_Camera::Late_Tick(_float fTimeDelta)
{
}

CShader_Camera* CShader_Camera::Create(_dev pDevice, _context pContext)
{
	CShader_Camera* pInstance = new CShader_Camera(pDevice, pContext);

	if (FAILED(pInstance->Init_Prototype()))
	{
		MSG_BOX("Failed to Create : CShader_Camera");
...
CGameObject* CShader_Camera::Clone(void* pArg)
{
	CShader_Camera* pInstance = new CShader_Camera(*this);

	if (FAILED(pInstance->Init(pArg)))
	{
		MSG_BOX("Failed to Clone : CShader_Camera");
		Safe_Release(pInstance);
	}
